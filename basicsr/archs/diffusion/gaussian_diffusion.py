...
class GaussianDiffusion:
    ...
    def q_sample_patch(self, x_start, t, noise=None,patch_size=16):
        """
        Diffuse the data for a given number of diffusion steps.
        In other words, sample from q(x_t | x_0).
        :param x_start: the initial data batch.
        ...
        patch_n = H//patch_size*W//patch_size

        x_start2= x_start.reshape(B,C,H//patch_size,patch_size,W//patch_size,patch_size)
        x_start2 = x_start2.permute(0,2,4,1,3,5).reshape(B*patch_n,C,patch_size,patch_size)
        ...
        x_start2 = x_start2.reshape(B,C,H,W)
        return x_start2
    ...
    def training_losses(self, model,target, x_start, t, model_kwargs=None, noise=None):
        """
    ...
    def training_losses_patch(self, model,target, x_start, t, model_kwargs=None, noise=None,patch_size=16):
        """
        Compute training losses for a single timestep.
        :param model: the model to evaluate loss on.
        :param x_start: the [N x C x ...] tensor of inputs.
