...
from data.degradation_util import degradationBenchmark
...
class DegradationTrainDataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(DegradationTrainDataset, self).__init__()
        self.opt = opt
        self.d_mode = opt['d_mode']
    ...
    def __getitem__(self, index):
        ...
        img_lq, img_gt = degradationBenchmark(img_gt, sf=scale, lq_patchsize_h=img_gt.shape[0] // scale, lq_patchsize_w=img_gt.shape[1] // scale, use_crop=False,d_mode = self.d_mode)
