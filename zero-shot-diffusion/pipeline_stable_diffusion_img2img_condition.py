...
class StableDiffusionImg2ImgPipeline_cond(
    DiffusionPipeline,
    ...
    def generate_cosine_list(self,start=100, end=1, num_steps=10):
        t = np.linspace(0, np.pi, num_steps)
        cos_values = np.cos(t)
        scaled_values = (cos_values + 1) / 2 * (start - end) + end
    ...
    def __call__(
        ...
        **kwargs,
        ...
        self.dps_scale = self.generate_cosine_list(start=100, end=0.1, num_steps=len(timesteps))
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if callback_on_step_end is not None:
                    ...
                    latents = callback_outputs.pop("latents", latents_param)
